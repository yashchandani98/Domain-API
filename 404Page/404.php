<?php
require('../lib/console-config.php');
...
<div class="loading"><img src="../assets/img/loading.gif" alt="loading-img"></div>
    <div class="stars">
        <div class="custom-navbar">
            ...
            <img src="../assets/img/logo.jpg" style="height: 80px !important; width: 150px !important;">
            </div>
            <div class="navbar-links">
                <ul>
                  <li><a href="<?=$MAINBASEURL?>" target="_blank">Home</a></li>
                  <li><a href="<?=$MAINBASEURL?>" target="_blank">About</a></li>
                </ul>
            </div>
        </div>
        <div class="central-body">
			...
			?>
            <a href="../<?=$_SESSION['currentPage']?>" class="btn-go-home">GO To Back Page</a>
			<?php } else{?>
			<a href="<?=$CONSOLEURL?>" class="btn-go-home">GO To Home Page</a>
			<?php }?>
        </div>
        <div class="objects">
            ...
            <div class="box_astronaut">
                <img class="object_astronaut" src="../assets/img/astronaut.svg" width="140px">
            </div>
        </div>
